...
> **Generado:** 2026-06-17  |  **Modo:** Simulación sintética
...
## 7. Detección de Comunidades con Louvain

Además de K-Means se aplicó el **algoritmo de Louvain** sobre un **grafo k-NN**
construido a partir de las mismas features. Mientras K-Means parte el espacio
por distancia a centroides (y exige fijar K), Louvain **descubre el número de
comunidades automáticamente** maximizando la *modularidad* Q.

### 7.1 Construcción del grafo

| Parámetro | Valor |
|-----------|-------|
| Nodos (actuadores train) | 84 |
| Vecinos k-NN (k) | 25 |
| Peso de arista | kernel gaussiano `exp(-d²/2σ²)`, σ adaptativo |
| Grafo | no dirigido, simetrizado por OR |
...
**Comunidades detectadas: 3**   |   **Modularidad Q = 0.5552**
...
![Grafo Louvain](animations/louvain_grafo.gif)

![Comunidades Louvain (PNG)](report/louvain_comunidades.png)

### 7.3 Comparación K-Means vs Louvain

Ambos métodos evaluados contra el ground truth sintético (3 estados de mantenimiento):
...
**Acuerdo directo K-Means ↔ Louvain** (sin ground truth):

- ARI = 1.000   |   NMI = 1.000

![Comparación lado a lado](report/comparacion_kmeans_louvain.png)
...
| ¿Requiere K? | Sí (auto-selección por silhouette) | No — K emerge de Q |
